...
namespace Hecres.Core.HecCSharp.Utilities.DataTypeWrappers.CryptedWrappers.Bases
{
    ...
    /// 暗号化対応floatの型クラスの基底
    /// </summary>
    public abstract class CryptedFloatBase<T> : ICryptedFloatValue, IComparable<T>, IEquatable<T>, IFormattable
        where T : CryptedFloatBase<T>
    {
        /// <summary>
        /// 等価判定の許容誤差
        /// </summary>
        public virtual float EqualsTolerance { get; } = 0.00001f;

        /// <summary>
        /// 復号後の値
        /// </summary>
        public float Value => IsEncrypted() ? HecEncryptor.DecryptFloat(encryptedValue, seed) : plainValue;

        private readonly float plainValue;
        ...
        protected CryptedFloatBase(float plainValue, bool useEncryption, Func<float, bool> isValidFunc, Func<float, float> processPlainValueFunc)
        {
        ...
        /// 等価演算子
        /// </summary>
        public static bool operator ==(CryptedFloatBase<T> a, CryptedFloatBase<T> b) => Equals(a, b);
        ...
        /// 小なり演算子
        /// </summary>
        public static bool operator <(CryptedFloatBase<T> a, CryptedFloatBase<T> b) => a.Value < b.Value;
