...
namespace Hecres.Core.HecCSharp.Utilities.DataTypeWrappers.CryptedWrappers.Bases
{
    ...
    /// 暗号化対応longの型クラスの基底
    /// </summary>
    public abstract class CryptedLongBase<T> : ICryptedLongValue, IComparable<T>, IEquatable<T>, IFormattable
        where T : CryptedLongBase<T>
    {
        /// <summary>
        /// 復号後の値
        /// </summary>
        public long Value => IsEncrypted() ? HecEncryptor.DecryptLong(encryptedValue, seed) : plainValue;

        private readonly long plainValue;
        ...
        protected CryptedLongBase(long plainValue, bool useEncryption, Func<long, bool> isValidFunc, Func<long, long> processPlainValueFunc)
        {
        ...
        /// 等価演算子
        /// </summary>
        public static bool operator ==(CryptedLongBase<T> a, CryptedLongBase<T> b) => Equals(a, b);
        ...
        /// 小なり演算子
        /// </summary>
        public static bool operator <(CryptedLongBase<T> a, CryptedLongBase<T> b) => a.Value < b.Value;
