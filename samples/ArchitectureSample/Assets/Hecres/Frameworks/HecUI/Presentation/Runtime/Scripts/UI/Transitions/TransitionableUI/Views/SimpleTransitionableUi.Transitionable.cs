...
namespace Hecres.Frameworks.HecUI.Presentation.UI.Transitions.TransitionableUI.Views
{
    public sealed partial class SimpleTransitionableUi : HecUnityMonoBehaviourBase
    {
        /// <summary>
        /// UIの非表示完了時に通知
        /// </summary>
