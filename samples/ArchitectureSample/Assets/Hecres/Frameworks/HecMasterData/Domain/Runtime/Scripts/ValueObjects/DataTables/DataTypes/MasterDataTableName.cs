...
namespace Hecres.Frameworks.HecMasterData.Domain.ValueObjects.DataTables.DataTypes
{
    ...
    /// マスターデータ名の型クラス
    /// </summary>
    public class MasterDataTableName : CryptedStringBase<MasterDataTableName>
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        ...
        public MasterDataTableName(string plainValue, bool useEncryption = false) : base(plainValue, useEncryption, IsValid, ProcessPlainValue)
        {
        }
